...
{
	long response; /* from before SInt32 was invented */
	OSErr err;
	...
	/* cast for second parameter is only correct on 10.5+ (FIXME): */
	err = Gestalt((OSType)gestaltMenuMgrAttr, (SInt32 *)&response);
